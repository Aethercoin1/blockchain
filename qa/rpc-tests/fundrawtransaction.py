...
class RawTransactionsTest(aethercoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid aethercoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid aethercoin address" in e.error['message'])
