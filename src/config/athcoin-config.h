/* src/config/aethercoin-config.h.  Generated from aethercoin-config.h.in by configure.  */
/* src/config/aethercoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef AETHERCOIN_CONFIG_H

#define AETHERCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The aethercoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "aethercoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/aethercoin/aether/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "aethercoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "aethercoin Core 4.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "aethercoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://aethercoin.org/"
