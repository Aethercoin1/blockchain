...
#ifndef AETHERCOIN_QT_SENDCOINSDIALOG_H
#define AETHERCOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending aethercoins */
...
public Q_SLOTS:
    ...
    void checkATHtechServers();
    void showATHTechDialog();
...
#endif // AETHERCOIN_QT_SENDCOINSDIALOG_H
