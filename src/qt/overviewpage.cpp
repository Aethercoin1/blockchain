...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(AetherCoinUnits::ATH),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QString amountText = AetherCoinUnits::formatWithUnit(unit, amount, true, AetherCoinUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& stakingBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(AetherCoinUnits::formatWithUnit(unit, balance, false, AetherCoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(AetherCoinUnits::formatWithUnit(unit, unconfirmedBalance, false, AetherCoinUnits::separatorAlways));
    ui->labelStaking->setText(AetherCoinUnits::formatWithUnit(unit, stakingBalance, false, AetherCoinUnits::separatorAlways));
    ui->labelImmature->setText(AetherCoinUnits::formatWithUnit(unit, immatureBalance, false, AetherCoinUnits::separatorAlways));
    ui->labelTotal->setText(AetherCoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + stakingBalance, false, AetherCoinUnits::separatorAlways));
...
void OverviewPage::updateStakeReport(bool fImmediate=false)
{
    ...
    ui->label24hStakingStats->setText(AetherCoinUnits::formatWithUnit(unit, aRange[i++].Total, false, AetherCoinUnits::separatorAlways));
    ui->label7dStakingStats->setText(AetherCoinUnits::formatWithUnit(unit, aRange[i++].Total, false, AetherCoinUnits::separatorAlways));
    ui->label30dStakingStats->setText(AetherCoinUnits::formatWithUnit(unit, aRange[i++].Total, false, AetherCoinUnits::separatorAlways));
