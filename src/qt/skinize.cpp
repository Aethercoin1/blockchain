...
QString Skinize()
{
    return "QDialog { background: #fff ; border: 0; }"
           ...
           "QPushButton:hover {  background: rgba(255,255,255,0.5); border: 1px solid #4682B4; border-radius: 3px; padding: 6px; margin: 3px; text-transform: uppercase; color: #6495ED; font-size: 11px; font-weight: Bold }"
           "QPushButton:pressed {  background: rgba(255,255,255,0.9); border: 1px solid #4682B4; border-radius: 3px; padding: 6px; margin: 3px; text-transform: uppercase; color: #6495ED; font-size: 11px; font-weight: Bold }"
