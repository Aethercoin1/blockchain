...
#ifndef AETHERCOIN_QT_AETHERCOINUNITS_H
#define AETHERCOIN_QT_AETHERCOINUNITS_H
...
/** AetherCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AetherCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AetherCoinUnits(QObject *parent);

    /** AetherCoin units.
      @note Source: https://en.aethercoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ATH,
...
typedef AetherCoinUnits::Unit AetherCoinUnit;

#endif // AETHERCOIN_QT_AETHERCOINUNITS_H
