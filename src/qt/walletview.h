...
#ifndef AETHERCOIN_QT_WALLETVIEW_H
#define AETHERCOIN_QT_WALLETVIEW_H
...
public:
    ...
    void setAetherCoinGUI(AetherCoinGUI *gui);
...
Q_SIGNALS:
    ...
    friend AetherCoinGUI;
};

#endif // AETHERCOIN_QT_WALLETVIEW_H
