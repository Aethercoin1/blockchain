    ...
    mapper(0)
{
    ...
    ui->aethercoinAtStartup->setToolTip(ui->aethercoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->aethercoinAtStartup->setText(ui->aethercoinAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->thirdPartyTxUrls->setPlaceholderText("https://chainz.cryptoid.info/ATH/tx.dws?%s.htm");
#endif

    ui->unit->setModel(new AetherCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->aethercoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openAetherCoinConfButton_clicked()
{
