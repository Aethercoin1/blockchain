...
#ifndef AETHERCOIN_QT_WALLETFRAME_H
#define AETHERCOIN_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, AetherCoinGUI *_gui = 0);
    ~WalletFrame();
...
#endif // AETHERCOIN_QT_WALLETFRAME_H
