...
#ifndef AETHERCOIN_WALLET_ATHTECH_H
#define AETHERCOIN_WALLET_ATHTECH_H
...
#define ATHTECH_DEFAULT_INPUT_DELAY 1
#define ATHTECH_DEFAULT_OUT_DELAY 10
#define ATHTECH_DEFAULT_ENTROPY 4
...
#endif //AETHERCOIN_WALLET_ATHTECH_H
