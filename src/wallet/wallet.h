...
#ifndef AETHERCOIN_WALLET_WALLET_H
#define AETHERCOIN_WALLET_WALLET_H
...
enum WalletFeature
{
    ...
    FEATURE_HD = 130001, // Hierarchical key derivation after BIP32 (HD Wallet)
...
#endif // AETHERCOIN_WALLET_WALLET_H
