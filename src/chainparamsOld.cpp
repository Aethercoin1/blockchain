...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    txNew.vout[0].scriptPubKey.clear();
    txNew.strDZeel = "AetherCoin genesis block";
...
{
    const char* pszTimestamp = "A new Aethercoin decentralized blockchian!";
    const CScript genesisOutputScript = CScript() << ParseHex("0402e65a3a31d08e88792a1041295430c217b0f4411c6fef54e5223940ab3d9b798b66d18511f2c34be9c1817a403862ea75433260afece623adbeb935128371f9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1526460147, 167495, 0x1f00ffff, 1, 0);
...
//                     printf("ssssnew mainnet genesis merkle root: %c\n", genesis.nNonce);
//                     printf("sssssnew mainnet genesis hash:  %s\n", hash.ToString().c_str());
//                     break;
//                }
//            }
...
//        }
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00007d15f48bf886394d6f73c5aa88646147db171177bd73b9e04fef4c20fe98"));
        assert(genesis.hashMerkleRoot == uint256S("0x4e5d4c6690bd12b87edb97023adcecdceb74fd0581f167bc16f96468e5634dd8"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            1526460147, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlockTestnet(1526460147, 2043078445, 0x1d00ffff, 1, 0);
//        consensus.hashGenesisBlock = uint256S("0x01");


       if (false && (genesis.GetHash() != consensus.hashGenesisBlock || genesis.hashMerkleRoot != uint256S("0x472868bc7686c2f3e852eb12ab1757c9f2b2848f13ad7f7b848eef70c3f86fdd")))
        {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000c1df60d9d4d5ee28752d27b64298e5d33cd54a4eb0d0219e6fc33a126189"));
        assert(genesis.hashMerkleRoot == uint256S("0x35fb46100ab92c18484dbd07040f1674d26912b439e974996021d02a8a084073"));
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1526388794, 2042883868, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
