...
static void http_reject_request_cb(struct evhttp_request* req, void*)
{
    ...
    evhttp_send_error(req, 0, NULL);
}

/** Event dispatcher thread */
static void ThreadHTTP(struct event_base* base, struct evhttp* http)
{
    RenameThread("aethercoin-http");
...
{
    RenameThread("aethercoin-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/aethercoin/aethercoin/pull/6990)
