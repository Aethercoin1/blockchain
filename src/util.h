 ...
 */
#ifndef AETHERCOIN_UTIL_H
#define AETHERCOIN_UTIL_H
...
extern const char * const AETHERCOIN_CONF_FILENAME;
extern const char * const AETHERCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("aethercoin-%s", name);
