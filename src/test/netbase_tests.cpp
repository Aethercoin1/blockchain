...
{
    BOOST_CHECK(TestSplitHost("www.aethercoin.org", "www.aethercoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.aethercoin.org]", "www.aethercoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.aethercoin.org:80", "www.aethercoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.aethercoin.org]:80", "www.aethercoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:5556", "127.0.0.1", 9444));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:5556", "127.0.0.1", 9444));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:5556", "::ffff:127.0.0.1", 9444));
    BOOST_CHECK(TestSplitHost("[::]:5556", "::", 9444));
    BOOST_CHECK(TestSplitHost("::5556", "::9444", -1));
    BOOST_CHECK(TestSplitHost(":5556", "", 9444));
    BOOST_CHECK(TestSplitHost("[]:5556", "", 9444));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:5556", "127.0.0.1:9444"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:5556", "[::]:9444"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
