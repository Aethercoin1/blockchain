...
#define BOOST_TEST_MODULE AetherCoin Test Suite

#include "test_aethercoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_aethercoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
