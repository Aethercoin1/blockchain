...
#ifndef AETHERCOIN_TEST_SCRIPTNUM10_H
#define AETHERCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from AetherCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // AETHERCOIN_TEST_BIGNUM_H
