...
#ifndef AETHERCOIN_SCRIPT_SCRIPT_H
#define AETHERCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, AetherCoin always counted CHECKMULTISIGs
...
#endif // AETHERCOIN_SCRIPT_SCRIPT_H
